package database.dao.dao_file.passenger;
...
class DaoPassengerFileTest {
    ...
    private final File file = new File("src/test/java/database/dao/dao_file/passenger/passengers.bin");
    private final File fileNonExisting = new File("src/test/java/database/dao/dao_file/passenger/none.bin");
    ...
    void getWithObjTest3() {
        makeEmpty();
        DaoPassengerFile daoPassengerFile = new DaoPassengerFile(file);
        assertEquals(Optional.empty(), daoPassengerFile.get(Passenger.getRandom()));
    }
