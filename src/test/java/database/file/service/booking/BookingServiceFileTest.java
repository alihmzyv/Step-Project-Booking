...
class BookingServiceFileTest {
    ...
    void getWithIdTest3() {
        makeEmpty();
        BookingService fs = new BookingService(new DaoBookingFile(file));
        assertThrowsExactly(NonInitializedDatabaseException.class, () ->  fs.getBooking(Booking.getRandom().getId()));
    }
    ...
    void getWithObjTest3() {
        makeEmpty();
        BookingService fs = new BookingService(new DaoBookingFile(file));
        assertThrowsExactly(NonInitializedDatabaseException.class, () -> fs.getBooking(Booking.getRandom()));
    }
    ...
    void removeWithIdTest3() {
        makeEmpty();
        BookingService fs = new BookingService(new DaoBookingFile(file));
        assertThrowsExactly(NonInitializedDatabaseException.class, () -> fs.removeBooking(Booking.getRandom().getId()));
    }
    ...
    void removeWithObjTest3() {
        makeEmpty();
        BookingService fs = new BookingService(new DaoBookingFile(file));
        assertThrowsExactly(NonInitializedDatabaseException.class, () -> fs.removeBooking(Booking.getRandom()));
    }
